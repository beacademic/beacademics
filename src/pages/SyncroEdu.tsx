...
import { BUSINESS_HOURS, SALES_EMAIL, SALES_PHONE_DISPLAY, SALES_PHONE_TEL, whatsappLink } from '../config/contact';
...
const UrgencyBar = () => {
    ...
    return (
        <aside aria-label="Aviso de planificación escolar" className="bg-white text-[#515154] text-xs md:text-sm py-2 px-4 text-center relative z-50 border-b border-black/5">
            <div className="max-w-7xl mx-auto flex items-center justify-center gap-2 pr-8">
                ...
                {isYearEnd ? (
                    <span className="text-[#515154]">
                        <strong className="text-[#1D1D1F]">Planificación Escolar {new Date().getFullYear() + 1}</strong> — Prepare el año escolar con contratos y horarios validados contra la normativa vigente.{' '}
                        <a href={whatsappLink('syncroedu', { message: 'Hola, quiero agendar una demo de SyncroEdu' })} target="_blank" rel="noopener noreferrer" className="text-[#1F7A38] hover:underline font-semibold ml-1">
                            Agendar demo gratuita &rarr;
                        </a>
                    </span>
                ) : (
                    <span className="text-[#515154]">
                        <strong className="text-[#1D1D1F]">Año Escolar en Curso</strong> — Valide la proporción 65/35 de su dotación docente y reduzca el riesgo de sanciones de la Superintendencia de Educación.{' '}
                        <a href={whatsappLink('syncroedu', { message: 'Hola, necesito asesoría sobre el cumplimiento de la regla 65/35 en SyncroEdu' })} target="_blank" rel="noopener noreferrer" className="text-[#1F7A38] hover:underline font-semibold ml-1">
                            Hablar con un asesor &rarr;
                        </a>
                    </span>
                )}
            </div>
            <button onClick={() => setIsVisible(false)} className="absolute right-4 top-1/2 -translate-y-1/2 text-[#515154] hover:text-[#1D1D1F] transition-colors" aria-label="Cerrar aviso">&times;</button>
        </aside>
    );
};

const pageUrl = canonicalUrl('/syncroedu/');

const faqs = [
    {
        q: "¿Reemplaza completamente el Excel y generadores tradicionales como aSc Timetables?",
        a: "Sí, de manera integral. SyncroEdu unifica la generación de la malla horaria con la validación de la legislación chilena (Leyes 20.903, 21.625 y 19.070) y la gestión de reemplazos en terreno, reduciendo la duplicación de planillas y el riesgo de error humano."
    },
    {
    ...
    },
    {
        ...
        a: "El despliegue toma aproximadamente 1 semana. Nuestro equipo de soporte realiza la carga inicial de docentes, contratos y restricciones, acompañada de 3 capacitaciones al equipo directivo. Después continúa un acompañamiento de 2 meses."
    },
    {
...
// El FAQPage se arma con las mismas preguntas y respuestas que se ven en pantalla.
const faqSchemaData = {
    "@context": "https://schema.org",
    "@type": "FAQPage",
        ...
        <div className="bg-[#F5F5F7] min-h-screen text-[#1D1D1F] font-sans selection:bg-[#34C759] selection:text-white">
                ...
                <nav className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between text-sm font-medium">
                    <div className="flex items-center gap-6 md:gap-8">
                        ...
                        <div className="flex items-center gap-2">
                            <LogoContainer className="w-8 h-8 bg-[#34C759]/10 border-[#34C759]/20">
                                <img src="/Logo-SyncroEdu.png" alt="SyncroEdu" width={254} height={289} className="h-5 w-5 object-contain" />
                            </LogoContainer>
                            <span className="font-bold text-base tracking-tight text-[#1D1D1F]">SyncroEdu</span>
                            <span className="hidden md:inline-block px-2 py-0.5 bg-[#34C759]/10 text-[#1F7A38] text-[11px] font-bold rounded-full border border-[#34C759]/20">
                                Chile Compliance
                            </span>
                        </div>
                        ...
                        <div className="hidden lg:flex items-center gap-6 text-[#515154]">
                            ...
                            <button onClick={() => document.getElementById('caso-piloto')?.scrollIntoView({ behavior: 'smooth' })} className="hover:text-[#1D1D1F] transition-colors cursor-pointer">Caso real</button>
                    ...
                    <div className="flex items-center gap-3">
                        <a 
                            ...
                            className="hidden sm:inline-flex text-xs font-semibold text-[#515154] hover:text-[#1D1D1F] transition-colors px-3 py-1.5"
                        >
                            Acceso Clientes
                        </a>
                        <PrimaryButton 
            ...
            <section id="hero" className="pt-20 pb-16 md:py-24 px-6 max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12 lg:gap-16 relative">
                <div className="flex-1 text-center lg:text-left z-10">
                    ...
                    <motion.div 
                        ...
                        className="flex flex-wrap items-center gap-x-6 gap-y-2 mt-8 text-xs text-[#515154] justify-center lg:justify-start font-medium"
                    >
                        ...
                        <span className="flex items-center gap-1.5"><Clock className="w-4 h-4 text-[#34C759]" /> Puesta en marcha en 1 semana</span>
                    </motion.div>
                    ...
                    <motion.p
                        ...
                        className="mt-6 text-sm text-[#515154] max-w-2xl mx-auto lg:mx-0 leading-relaxed"
                    >
                        SyncroEdu es la opción si necesita validar la normativa chilena (regla 65/35, horas PIE) además de generar el horario. ¿Solo necesita el horario?{' '}
                        <Link to="/syncrotime/" className="font-semibold text-[#0066CC] hover:underline underline-offset-2">
                ...
                >
                    <div className="relative rounded-3xl bg-white border border-black/5 p-3 shadow-2xl overflow-hidden group">
                        ...
                        <div className="flex items-center justify-between px-3 py-2 border-b border-black/5 mb-3 bg-[#F5F5F7]/60 rounded-t-2xl">
                            ...
                            <span className="text-[11px] font-semibold text-[#515154]">SyncroEdu — Plataforma de Compliance Escolar</span>
                            <div className="w-12" />
                        </div>
                        ...
                        <div className="rounded-2xl overflow-hidden border border-black/5 bg-white relative">
                            <img 
                                src="/Dashboard.webp" 
                                alt="Centro de Mando de SyncroEdu: continuidad del aula, mapa de disponibilidad docente e indicadores de dotación" 
                                width={1600}
                                height={1231}
                                loading="eager"
                                decoding="async"
                                ...
                                onError={(e) => {
                                    ...
                                    if (e.currentTarget.parentElement) {
                                        e.currentTarget.parentElement.innerHTML += '<div class="h-80 flex items-center justify-center text-[#515154] font-bold text-lg">Dashboard SyncroEdu</div>';
                                    }
                                }}
                            />
                        </div>
                        ...
                        <div className="absolute bottom-6 right-6 bg-white/95 backdrop-blur-md p-4 rounded-2xl shadow-xl border border-black/5 hidden sm:flex items-center gap-3 z-20">
                            ...
                            <div>
                                <p className="text-xs font-bold text-[#1D1D1F]">Validación normativa continua</p>
                                <p className="text-[11px] text-[#515154]">Proporción 65/35 y Ley 20.903 verificadas por el sistema</p>
                            </div>
                        </div>
                    </div>
                </motion.div>
            ...
            <section className="px-6 max-w-7xl mx-auto mb-16">
                <div className="rounded-3xl bg-white border border-black/5 p-6 md:p-8 shadow-sm flex flex-col md:flex-row items-center justify-between gap-6">
                    <div>
                        <span className="text-xs font-bold text-[#515154] uppercase tracking-wider block mb-1">Caso en producción</span>
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 sm:gap-10 text-center w-full md:w-auto">
                        <div>
                            <p className="text-3xl font-extrabold text-[#1F7A38] tracking-tight">62</p>
                            <p className="text-xs text-[#515154] font-medium">Docentes Activos</p>
                        </div>
                        <div>
                            <p className="text-3xl font-extrabold text-[#1F7A38] tracking-tight">36</p>
                            <p className="text-xs text-[#515154] font-medium">Asistentes Educación</p>
                        </div>
                        <div>
                            <p className="text-3xl font-extrabold text-[#1F7A38] tracking-tight">900+</p>
                            <p className="text-xs text-[#515154] font-medium">Estudiantes JEC</p>
                        </div>
                        <div>
                            <p className="text-3xl font-extrabold text-[#1F7A38] tracking-tight">1-3 días</p>
                            <p className="text-xs text-[#515154] font-medium">Confección Total</p>
                        </div>
                    </div>
                </div>
            </section>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    <BentoCard glowColor="#FF3B30">
                        ...
                        <div className="text-3xl md:text-4xl font-black text-[#1D1D1F] tracking-tight mb-2">
                            {counterAnimation(1434000)} <span className="text-xs font-semibold text-[#515154]">CLP</span>
                        </div>
                    ...
                    <BentoCard glowColor="#FF3B30">
                        ...
                        <div className="text-3xl md:text-4xl font-black text-[#1D1D1F] tracking-tight mb-2">
                            {counterAnimation(9000000)} <span className="text-xs font-semibold text-[#515154]">CLP</span>
                        </div>
                    ...
                    <BentoCard glowColor="#FF9500">
                        ...
                        <div className="text-3xl md:text-4xl font-black text-[#1D1D1F] tracking-tight mb-2">
                            {counterAnimation(1687500)} <span className="text-xs font-semibold text-[#515154]">CLP</span>
                        </div>
                    ...
                    <BentoCard glowColor="#007AFF">
                        ...
                        <div className="text-3xl md:text-4xl font-black text-[#1D1D1F] tracking-tight mb-2">
                            {counterAnimation(2500000)} <span className="text-xs font-semibold text-[#515154]">CLP</span>
                        </div>
                    ...
                    <div className="rounded-3xl bg-white border border-black/5 p-8 shadow-sm">
                        <div className="flex items-center gap-3 mb-6 pb-6 border-b border-black/5">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-[#515154]">aSc Timetables · Prime Timetable · Planillas</p>
                            </div>
                        </div>
                    ...
                    <div className="rounded-3xl bg-white border border-[#34C759]/30 p-8 shadow-xl relative overflow-hidden">
                        ...
                        <div className="relative z-10 flex items-center gap-3 mb-6 pb-6 border-b border-black/5">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-[#1F7A38] font-semibold">Compliance Escolar y Continuidad Operativa</p>
                            </div>
                        </div>
            ...
            <section id="pilares" className="py-16 md:py-24 px-6 max-w-7xl mx-auto">
                <div className="text-center mb-12">
                    ...
                    <p className="text-base md:text-lg text-[#515154] max-w-2xl mx-auto font-normal">
                ...
                <div className="rounded-3xl bg-white border border-black/5 p-8 md:p-12 shadow-xl">
                    {activeTab === 0 && (
                        <div className="flex flex-col lg:flex-row items-center gap-12">
                            <div className="flex-1 space-y-6">
                                <StatusBadge label="MÓDULO 01 · MOTOR DE OPTIMIZACIÓN" variant="primary" pulse={false} />
                                ...
                                <p className="text-[#515154] text-base md:text-lg leading-relaxed font-normal">
                            ...
                            <div className="flex-1 w-full rounded-2xl overflow-hidden border border-black/5 bg-[#F5F5F7] p-2 shadow-inner">
                                <img src="/Generador.webp" alt="Pantalla de generación de horario de SyncroEdu con barra de progreso" width={1600} height={880} loading="lazy" decoding="async" className="w-full h-auto object-cover rounded-xl" />
                            </div>
                        </div>
                    )}
                    ...
                    {activeTab === 1 && (
                        <div className="flex flex-col lg:flex-row items-center gap-12">
                            <div className="flex-1 space-y-6">
                                <StatusBadge label="MÓDULO 02 · VALIDACIÓN NORMATIVA" variant="success" pulse={false} />
                                <h3 className="text-3xl md:text-4xl font-bold text-[#1D1D1F] font-display">
                                    Auditoría automática de las Leyes 20.903, 21.625 y 19.070.
                                </h3>
                                <p className="text-[#515154] text-base md:text-lg leading-relaxed font-normal">
                                    SyncroEdu funciona como una herramienta de apoyo normativo continuo. Comprueba en tiempo real que cada docente mantenga la proporción lectiva y no lectiva exigida por la legislación chilena, para ayudar a prevenir sanciones antes de una fiscalización.
                                </p>
                                <div className="rounded-2xl bg-[#F5F5F7] border border-black/5 p-4 text-xs font-mono text-[#1D1D1F]">
                                    ...
                                    <div className="grid grid-cols-3 py-1 text-[#515154]">
                                        <div className="font-semibold text-[#1D1D1F]">Estándar Nacional</div>
                                        <div className="text-center text-[#1F7A38] font-bold">65%</div>
                                        <div className="text-center text-[#1F7A38] font-bold">35%</div>
                                    </div>
                                    <div className="grid grid-cols-3 py-1 text-[#515154]">
                            ...
                            <div className="flex-1 w-full rounded-2xl overflow-hidden border border-black/5 bg-[#F5F5F7] p-2 shadow-inner">
                                <img src="/Semaforo-1.webp" alt="Semáforo de cumplimiento normativo por docente en SyncroEdu" width={1600} height={424} loading="lazy" decoding="async" className="w-full h-auto object-cover rounded-xl" />
                            </div>
                        </div>
                    )}
                    ...
                    {activeTab === 2 && (
                        <div className="flex flex-col lg:flex-row items-center gap-12">
                            <div className="flex-1 space-y-6">
                                ...
                                <h3 className="text-3xl md:text-4xl font-bold text-[#1D1D1F] font-display">
                                    Reemplazos urgentes desde el celular en segundos.
                                </h3>
                                <p className="text-[#515154] text-base md:text-lg leading-relaxed font-normal">
                            ...
                            <div className="flex-1 w-full rounded-2xl overflow-hidden border border-black/5 bg-[#F5F5F7] p-2 shadow-inner">
                                <img src="/Dashboard-movil.webp" alt="App móvil de SyncroEdu con el resumen operativo y la cobertura de reemplazos del día" width={1600} height={1231} loading="lazy" decoding="async" className="w-full h-auto object-cover rounded-xl" />
                            </div>
                        </div>
                    )}
                    ...
                    {activeTab === 3 && (
                        <div className="flex flex-col lg:flex-row items-center gap-12">
                            <div className="flex-1 space-y-6">
                                <StatusBadge label="MÓDULO 04 · ANALÍTICA DE PERSONAS" variant="warning" pulse={false} />
                                <h3 className="text-3xl md:text-4xl font-bold text-[#1D1D1F] font-display">
                                    Decisiones estratégicas respaldadas con analítica de RRHH.
                                </h3>
                                <p className="text-[#515154] text-base md:text-lg leading-relaxed font-normal">
                                    SyncroEdu traduce la operación diaria en indicadores de gestión de personas: ausentismo reiterado, tasa de ocupación de aulas y simulador financiero para el programa PIE.
                                </p>
                                <div className="space-y-3 text-sm text-[#1D1D1F]">
                                    <div className="flex items-center gap-3">
                                        <CheckCircle2 className="w-5 h-5 text-[#34C759] shrink-0" />
                            ...
                            <div className="flex-1 w-full rounded-2xl overflow-hidden border border-black/5 bg-[#F5F5F7] p-2 shadow-inner">
                                <img src="/Gestion-de-personas.webp" alt="Panel de analítica de personas de SyncroEdu: ausentismo, ocupación docente y simulador de costos" width={1600} height={1122} loading="lazy" decoding="async" className="w-full h-auto object-cover rounded-xl" />
                            </div>
                        </div>
                    )}
                </div>
            ...
            <section id="caso-piloto" className="py-16 md:py-24 px-6 max-w-5xl mx-auto">
                <div className="text-center mb-12">
                    <StatusBadge label="CASO REAL" variant="success" pulse={false} className="mb-4" />
                    <h2 className="text-3xl md:text-5xl font-bold tracking-tight text-[#1D1D1F] mb-4 font-display">
                        Establecimiento Subvencionado: De 3 semanas a 1-3 días
                    </h2>
                    <p className="text-base md:text-lg text-[#515154] max-w-2xl mx-auto font-normal">
                        Resultados reportados por el colegio piloto: establecimiento particular subvencionado con jornada escolar completa.
                    </p>
                </div>
                ...
                <BentoCard glowColor="#34C759" className="p-8 md:p-10 mb-8">
                    <div className="flex flex-col sm:flex-row items-center justify-between gap-6 pb-8 border-b border-black/5 text-center sm:text-left">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-[#515154]">Región del Biobío · Jornada Escolar Completa (JEC)</p>
                            </div>
                        </div>

                        <div className="flex items-center gap-6 text-xs font-bold text-[#1F7A38]">
                    ...
                    <div className="mt-8 overflow-x-auto">
                        <table className="w-full text-left text-sm">
                            <thead>
                                <tr className="border-b border-black/5 text-xs font-bold text-[#515154] uppercase tracking-wider">
                                    <th className="py-3 px-4">Indicador de Desempeño</th>
                                    <th className="py-3 px-4 text-[#FF3B30]">Método Previo (Excel)</th>
                                    <th className="py-3 px-4 text-[#1F7A38]">Con SyncroEdu</th>
                                </tr>
                            </thead>
                            <tbody className="divide-y divide-black/5">
                                <tr>
                                    ...
                                    <td className="py-4 px-4 text-[#1F7A38] font-bold">1 a 3 días hábiles</td>
                                </tr>
                                <tr>
                                    <td className="py-4 px-4 font-semibold text-[#1D1D1F]">Cuadratura de horarios y contratos para remuneraciones</td>
                                    <td className="py-4 px-4 text-[#FF3B30]">Manual (alto riesgo de error humano)</td>
                                    <td className="py-4 px-4 text-[#1F7A38] font-bold">Validada por el sistema</td>
                                </tr>
                                <tr>
                                    ...
                                    <td className="py-4 px-4 text-[#1F7A38] font-bold">Registro auditable de cada cambio</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
            ...
            <section id="roles" className="py-16 md:py-24 px-6 max-w-7xl mx-auto">
                <div className="text-center mb-14">
                    ...
                    <h2 className="text-3xl md:text-5xl font-bold tracking-tight text-[#1D1D1F] mb-4 font-display">
                        Respuesta a las prioridades de cada miembro directivo
                    </h2>
                    <p className="text-base md:text-lg text-[#515154] max-w-2xl mx-auto font-normal">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <BentoCard glowColor="#007AFF">
                        ...
                        <ul className="space-y-3 text-sm text-[#515154]">
                            <li className="flex items-start gap-2">
                                <Check className="w-4 h-4 text-[#007AFF] shrink-0 mt-0.5" />
                                <span>Menor riesgo de multas de la Superintendencia.</span>
                            </li>
                            <li className="flex items-start gap-2">
                                <Check className="w-4 h-4 text-[#007AFF] shrink-0 mt-0.5" />
                    ...
                    <BentoCard glowColor="#34C759">
                        ...
                        <p className="text-xs text-[#1F7A38] font-semibold mb-4">Continuidad y Operación Diaria</p>
                        <ul className="space-y-3 text-sm text-[#515154]">
                            <li className="flex items-start gap-2">
                                <Check className="w-4 h-4 text-[#34C759] shrink-0 mt-0.5" />
                                <span>Reemplazos asignados desde el celular.</span>
                            </li>
                            <li className="flex items-start gap-2">
                                <Check className="w-4 h-4 text-[#34C759] shrink-0 mt-0.5" />
                                <span>Alertas para evitar aulas sin docente durante la jornada.</span>
                            </li>
                            <li className="flex items-start gap-2">
                                <Check className="w-4 h-4 text-[#34C759] shrink-0 mt-0.5" />
                                <span>Bitácora de reemplazos lista para fiscalizaciones.</span>
                            </li>
                        </ul>
                    </BentoCard>
                    ...
                    <BentoCard glowColor="#5856D6">
                        ...
                        <ul className="space-y-3 text-sm text-[#515154]">
                            <li className="flex items-start gap-2">
                                ...
                                <span>Horarios listos en 1 a 3 días, validados contra la normativa.</span>
                            </li>
                            <li className="flex items-start gap-2">
                                <Check className="w-4 h-4 text-[#5856D6] shrink-0 mt-0.5" />
                            ...
                            <li className="flex items-start gap-2">
                                <Check className="w-4 h-4 text-[#5856D6] shrink-0 mt-0.5" />
                                <span>Menos semanas de cálculos manuales.</span>
                            </li>
                        </ul>
                    </BentoCard>
                </div>
            ...
            <section id="proceso" className="py-16 md:py-24 px-6 max-w-7xl mx-auto">
                <div className="text-center mb-14">
                    ...
                    <p className="text-base md:text-lg text-[#515154] max-w-2xl mx-auto font-normal">
                        Un proceso acompañado por especialistas en normativa educacional chilena, con 2 meses de acompañamiento posterior.
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    {[
                        ...
                        <BentoCard key={i} glowColor="#34C759" className="p-6">
                            <div className="flex items-center justify-between mb-4">
                                <span className="text-2xl font-black text-[#1F7A38] font-mono">{item.step}</span>
                                <span className="text-[11px] font-semibold text-[#515154] bg-[#E8E8ED] px-2.5 py-1 rounded-full">{item.time}</span>
                            </div>
                            <div className="mb-3">{item.icon}</div>
                            <h4 className="font-bold text-base text-[#1D1D1F] mb-2 font-display">{item.title}</h4>
                            <p className="text-xs text-[#515154] leading-relaxed">{item.desc}</p>
                        </BentoCard>
                    ))}
                </div>
            </section>
            ...
            <section className="py-16 md:py-24 px-6 max-w-7xl mx-auto">
                <div className="text-center mb-14">
                    ...
                    <p className="text-base md:text-lg text-[#515154] max-w-2xl mx-auto font-normal">
                        Protegemos la privacidad y la seguridad de los datos de su institución.
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    <BentoCard glowColor="#007AFF">
                        ...
                        <p className="text-xs text-[#515154] leading-relaxed">Infraestructura en Google Cloud (Cloud Run y Cloud SQL), región Santiago, con alta disponibilidad, respaldo automático y disponibilidad objetivo de 99,5%.</p>
                    </BentoCard>

                    <BentoCard glowColor="#34C759">
                        <Lock className="w-8 h-8 text-[#34C759] mb-4" />
                        <h4 className="font-bold text-base text-[#1D1D1F] mb-2 font-display">Cifrado de datos</h4>
                        <p className="text-xs text-[#515154] leading-relaxed">Datos cifrados en tránsito y en reposo.</p>
                    </BentoCard>

                    <BentoCard glowColor="#5856D6">
                        <Building2 className="w-8 h-8 text-[#5856D6] mb-4" />
                        <h4 className="font-bold text-base text-[#1D1D1F] mb-2 font-display">Datos separados por colegio</h4>
                        <p className="text-xs text-[#515154] leading-relaxed">Cada establecimiento accede solo a sus propios datos, con separación lógica por institución.</p>
                    </BentoCard>
                    ...
                    <BentoCard glowColor="#FF9500">
                        ...
                        <p className="text-xs text-[#515154] leading-relaxed">Cualquier ajuste realizado en la web se propaga a la app móvil de los directivos al instante.</p>
                    </BentoCard>
                </div>
            </section>
                    ...
                    {faqs.map((faq, i) => (
                        <div key={i} className="rounded-2xl border border-black/5 bg-white overflow-hidden shadow-xs">
                            ...
                            >
                                ...
                                <span className="text-xl font-bold text-[#1F7A38] shrink-0">{faqOpen === i ? '−' : '+'}</span>
                            </button>
                            <AnimatePresence>
                                {faqOpen === i && (
                    ...
                    <div className="lg:col-span-5 space-y-6">
                        ...
                        <div className="pt-4">
                            ...
                            >
                                ...
                                <span>{SALES_PHONE_DISPLAY} (WhatsApp Directo)</span>
                            </a>
                        </div>
                    </div>
                    ...
                    <div className="lg:col-span-7">
                        <div className="rounded-3xl bg-white border border-black/5 p-8 md:p-10 shadow-xl">
                            <div className="border-b border-black/5 pb-4 mb-6">
                                ...
                                <p className="text-xs text-[#515154]">Complete los datos para coordinar una sesión técnica vía Meet o Zoom.</p>
                            </div>

                            <HubSpotForm
                                formId={HUBSPOT_FORMS.syncroeduDemo}
                                whatsappProduct="syncroedu"
                                whatsappMessage="Hola, quiero agendar una demo de SyncroEdu"
                                className="[&_.hs-form]:!font-sans"
                            />

                            <p className="text-[11px] text-center text-[#515154] pt-4">
                                Sus datos se tratan según nuestra <Link to="/privacidad-syncroedu/" className="underline hover:text-[#1D1D1F] transition-colors">Política de Privacidad</Link>. No enviamos spam.
                            </p>
                            <p className="text-sm text-center pt-3">
                                <a
                                    href={whatsappLink('syncroedu', { message: 'Hola, quiero agendar una demo de SyncroEdu' })}
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="font-semibold text-[#1F7A38] hover:underline underline-offset-2"
                                >
                                    ¿Prefiere WhatsApp? Escríbanos
                                </a>
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="relative z-10 max-w-3xl mx-auto space-y-6">
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
                            <PrimaryButton 
                                variant="green"
                                size="lg"
                                href={whatsappLink('syncroedu', { message: 'Hola, quisiera agendar una demostración de SyncroEdu' })}
                                target="_blank"
                                rel="noopener noreferrer"
            ...
            <footer className="bg-[#1C1C1E] text-[#86868B] py-14 text-sm border-t border-white/10">
                <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
                    <div className="md:col-span-2 space-y-4">
                        <div className="flex items-center gap-2">
                            <LogoContainer className="w-8 h-8 bg-white/10 border-white/15">
                                <img src="/Logo-SyncroEdu.png" alt="SyncroEdu" width={254} height={289} loading="lazy" decoding="async" className="h-5 w-5 object-contain" />
                            </LogoContainer>
                    ...
                    <div>
                        ...
                        <div className="flex flex-col gap-2.5 text-xs">
                            ...
                            <button onClick={() => document.getElementById('caso-piloto')?.scrollIntoView({ behavior: 'smooth' })} className="hover:text-white transition-colors text-left cursor-pointer">Caso real</button>
                            ...
                            <Link to="/condiciones-syncroedu/" className="hover:text-white transition-colors">Condiciones de Servicio</Link>
                            <Link to="/privacidad-syncroedu/" className="hover:text-white transition-colors">Política de Privacidad</Link>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="space-y-2 text-xs">
                            <p className="flex items-center gap-2">
                                ...
                                <a href={`tel:${SALES_PHONE_TEL}`} className="hover:text-white transition-colors">{SALES_PHONE_DISPLAY}</a>
                            </p>
                            <p className="flex items-center gap-2">
                            ...
                            <p className="text-[11px] text-[#86868B] pt-2">{BUSINESS_HOURS}</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="max-w-7xl mx-auto px-6 pt-8 border-t border-white/5 flex flex-col md:flex-row justify-between text-xs text-[#86868B] gap-4">
                    <p>SyncroEdu &copy; {new Date().getFullYear()} Sociedad de Formación BE Academic Limitada. Todos los derechos reservados.</p>
                    <p>Plataforma de compliance escolar para establecimientos educacionales de Chile.</p>
                </div>
            </footer>

            {/* BOTÓN FLOTANTE WHATSAPP APPLE HIG */}
            <a 
                href={whatsappLink('syncroedu', { message: 'Hola, deseo consultar sobre SyncroEdu' })} 
                target="_blank" 
                rel="noopener noreferrer" 
                className="fixed bottom-6 right-6 z-50 flex items-center gap-2.5 bg-[#1F7A38] text-white px-5 py-3 rounded-full shadow-[0_4px_20px_rgba(31,122,56,0.4)] font-semibold text-sm hover:scale-105 active:scale-95 transition-all"
