            ...
            <section className="pt-32 pb-24 px-6 max-w-4xl mx-auto flex-grow w-full">
                ...
                >
                    ...
                    <div className="bg-white p-8 md:p-12 rounded-3xl shadow-sm border border-gray-100 prose prose-lg max-w-none text-gray-600">
                        ...
                        <p className="mb-4">Para garantizar alta disponibilidad, escalabilidad y un procesamiento seguro de la información, nuestra plataforma utiliza servicios de terceros especializados, específicamente <strong>Google Cloud</strong> y <strong>Firebase</strong>, para el procesamiento y almacenamiento de datos.</p>
